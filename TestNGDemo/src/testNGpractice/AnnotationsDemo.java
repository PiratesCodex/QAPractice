...
public class AnnotationsDemo {
	...
	public void setUp() {
		System.setProperty("webdriver.chrome.driver",
				"D:\\ZsnrJavaWorkspace\\TestNGDemo\\BrowserDriver\\chromedriver.exe");
	...
	public void checkLogin() throws InterruptedException {
		...
		Thread.sleep(2500);
		driver.findElement(By.xpath("//input[@name='email']")).sendKeys("User61@gmail.com");
...
//		organization.sendKeys("LambdaTest");
		...
		email.sendKeys("User61@gmail.com");
		Thread.sleep(2500);
